/**
 * sales_return.js - UI Schema cho nghiệp vụ Trả Hàng Bán
 * 
...
export default {
  ...
  eventName: 'Trả Hàng Bán',
  description: 'Nghiệp vụ khách hàng trả hàng bán',
  ...
  fields: [
    ...
    
    {
      ...
      type: 'SELECT',
      label: 'Hóa đơn bán gốc',
      required: true,
      source: '/api/invoices?type=sale',
  ...
  backend: {
    ...
    accounting: {
      debit: ['REVENUE', 'AR'],
      credit: ['INVENTORY', 'MERCHANDISE', 'COST_OF_GOODS']
    }
  }
};